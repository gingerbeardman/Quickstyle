...
function StyleBox(id) {
	...
	sb.initPnS = function () {
		sb.pw = 16;
		sb.w = settings.styleBoxStats.width;
		sb.h = settings.styleBoxStats.height;
		sb.x = settings.styleBoxStats.left || window.innerWidth / 2 - sb.w / 2;
		sb.y = settings.styleBoxStats.top || window.innerHeight - sb.h - 24;
	...
	sb.stopMove = function(e) {
		if (e.button === 0) {
			settings.styleBoxStats.left = sb.offsetLeft;
			settings.styleBoxStats.top = sb.offsetTop;
			var message = { left: sb.offsetLeft, top: sb.offsetTop };
